...
import { calculateBackPay, calculateCompensationQuote, normalizeDependentProfile } from '../services/compensationService.js';
...
router.get('/supported-years', (req, res) => {
  res.json({ 
