...
```bash
#1: basename-braces
  micromatch x 26,420 ops/sec Â±0.89% (91 runs sampled)
  minimatch x 3,507 ops/sec Â±0.64% (97 runs sampled)
#2: basename
  micromatch x 25,315 ops/sec Â±0.82% (93 runs sampled)
  minimatch x 4,398 ops/sec Â±0.86% (94 runs sampled)
#3: braces-no-glob
  micromatch x 341,254 ops/sec Â±0.78% (93 runs sampled)
  minimatch x 30,197 ops/sec Â±1.12% (91 runs sampled)
#4: braces
  micromatch x 54,649 ops/sec Â±0.74% (94 runs sampled)
  minimatch x 3,095 ops/sec Â±0.82% (95 runs sampled)
#5: immediate
  micromatch x 16,719 ops/sec Â±0.79% (95 runs sampled)
  minimatch x 4,348 ops/sec Â±0.86% (96 runs sampled)
#6: large
  micromatch x 721 ops/sec Â±0.77% (94 runs sampled)
  minimatch x 17.73 ops/sec Â±1.08% (50 runs sampled)
#7: long
  micromatch x 5,051 ops/sec Â±0.87% (97 runs sampled)
  minimatch x 628 ops/sec Â±0.83% (94 runs sampled)
#8: mid
  micromatch x 51,280 ops/sec Â±0.80% (95 runs sampled)
  minimatch x 1,923 ops/sec Â±0.84% (95 runs sampled)
#9: multi-patterns
  micromatch x 22,440 ops/sec Â±0.97% (94 runs sampled)
  minimatch x 2,481 ops/sec Â±1.10% (94 runs sampled)
#10: no-glob
  micromatch x 722,823 ops/sec Â±1.30% (87 runs sampled)
  minimatch x 52,967 ops/sec Â±1.09% (94 runs sampled)
#11: range
  micromatch x 243,471 ops/sec Â±0.79% (94 runs sampled)
  minimatch x 11,736 ops/sec Â±0.82% (96 runs sampled)
#12: shallow
  micromatch x 190,874 ops/sec Â±0.98% (95 runs sampled)
  minimatch x 21,699 ops/sec Â±0.81% (97 runs sampled)
#13: short
  micromatch x 496,393 ops/sec Â±3.86% (90 runs sampled)
  minimatch x 53,765 ops/sec Â±0.75% (95 runs sampled)
```
## Tests
### Running tests
...
## Related
* [braces](https://www.npmjs.com/package/braces): Fastest brace expansion for node.js, with the most complete support for the Bash 4.3 bracesâ€¦ [more](https://github.com/jonschlinkert/braces) | [homepage](https://github.com/jonschlinkert/braces "Fastest brace expansion for node.js, with the most complete support for the Bash 4.3 braces specification.")
* [expand-brackets](https://www.npmjs.com/package/expand-brackets): Expand POSIX bracket expressions (character classes) in glob patterns. | [homepage](https://github.com/jonschlinkert/expand-brackets "Expand POSIX bracket expressions (character classes) in glob patterns.")
* [expand-range](https://www.npmjs.com/package/expand-range): Fast, bash-like range expansion. Expand a range of numbers or letters, uppercase or lowercase. Seeâ€¦ [more](https://github.com/jonschlinkert/expand-range) | [homepage](https://github.com/jonschlinkert/expand-range "Fast, bash-like range expansion. Expand a range of numbers or letters, uppercase or lowercase. See the benchmarks. Used by micromatch.")
* [extglob](https://www.npmjs.com/package/extglob): Convert extended globs to regex-compatible strings. Add (almost) the expressive power of regular expressions toâ€¦ [more](https://github.com/jonschlinkert/extglob) | [homepage](https://github.com/jonschlinkert/extglob "Convert extended globs to regex-compatible strings. Add (almost) the expressive power of regular expressions to glob patterns.")
* [fill-range](https://www.npmjs.com/package/fill-range): Fill in a range of numbers or letters, optionally passing an increment or multiplier toâ€¦ [more](https://github.com/jonschlinkert/fill-range) | [homepage](https://github.com/jonschlinkert/fill-range "Fill in a range of numbers or letters, optionally passing an increment or multiplier to use.")
