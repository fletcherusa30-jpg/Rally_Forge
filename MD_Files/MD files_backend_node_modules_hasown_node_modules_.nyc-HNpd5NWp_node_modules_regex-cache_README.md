...
# no args passed (defaults)
  with-cache x 8,699,231 ops/sec Â±0.86% (93 runs sampled)
  without-cache x 2,777,551 ops/sec Â±0.63% (95 runs sampled)
# string and six options passed
  with-cache x 1,885,934 ops/sec Â±0.80% (93 runs sampled)
  without-cache x 1,256,893 ops/sec Â±0.65% (97 runs sampled)
# string only
  with-cache x 7,723,256 ops/sec Â±0.87% (92 runs sampled)
  without-cache x 2,303,060 ops/sec Â±0.47% (99 runs sampled)
# one option passed
  with-cache x 4,179,877 ops/sec Â±0.53% (100 runs sampled)
  without-cache x 2,198,422 ops/sec Â±0.47% (95 runs sampled)
# two options passed
  with-cache x 3,256,222 ops/sec Â±0.51% (99 runs sampled)
  without-cache x 2,121,401 ops/sec Â±0.79% (97 runs sampled)
# six options passed
  with-cache x 1,816,018 ops/sec Â±1.08% (96 runs sampled)
  without-cache x 1,157,176 ops/sec Â±0.53% (100 runs sampled)
#
# diminishing returns happen about here
#
# ten options passed
  with-cache x 1,210,598 ops/sec Â±0.56% (92 runs sampled)
  without-cache x 1,665,588 ops/sec Â±1.07% (100 runs sampled)
# twelve options passed
  with-cache x 1,042,096 ops/sec Â±0.68% (92 runs sampled)
  without-cache x 1,389,414 ops/sec Â±0.68% (97 runs sampled)
# twenty options passed
  with-cache x 661,125 ops/sec Â±0.80% (93 runs sampled)
  without-cache x 1,208,757 ops/sec Â±0.65% (97 runs sampled)
#
# when non-primitive values are compared
#
# single value on the options is an object
  with-cache x 1,398,313 ops/sec Â±1.05% (95 runs sampled)
  without-cache x 2,228,281 ops/sec Â±0.56% (99 runs sampled)
```
## Run benchmarks
