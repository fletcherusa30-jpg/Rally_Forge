...
- `/api/financial-planner/*` - Financial planning endpoints
...
```
VA SCANNER/backend/
├── index.js                            # Export scanner functions
├── scannerRoute.js                     # Express route handler
├── services/                           # Scanner logic & parsers
├── shared/
│  └── scanner/                         # Shared scanner utilities
└── [supporting files]
```
...
```
VA SCANNER/frontend/
├── ScannerPanel.jsx                    # Reusable scanner UI component
├── useScanner.js                       # React hook for scanner
└── utils/                              # Client-side utilities
```

**API Endpoints:**
- `POST /api/scanner/scan-text` - Scan text document
- `POST /api/scanner/scan-pdf` - Scan PDF document
...
**Integration:**
- Backend endpoints: `/api/financial-planner/*`
...
### Scanner Imports
```javascript
// From VA SCANNER backend
import { scanText, scanPDF } from '../VA SCANNER/backend/scannerRoute.js';
import { ScannerPanel } from '../VA SCANNER/frontend/ScannerPanel.jsx';
```
