...
**Location:** `app/frontend-modern/src/pages/VARatingDecisionPage.jsx`  
...
## ❌ Legacy HTML Frontend (MISSING COMPENSATION)

**Location:** `frontend/modules/onboarding/index.html`  
**URL:** http://localhost:5174  
**Status:** ❌ **Only shows percentage, no dollar amounts**
...
# Terminal 2: Start static HTML server
npm run dev:web
```
...
### Issue:
The legacy HTML frontend is a static template without JavaScript integration to fetch and display compensation amounts.
...
**Location:** `backend/engine/compensationEngine.js` (570 lines)  
